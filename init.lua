...
local config = {
        ...
        mappings = {
                ...
                n = {
                        ...
                        ["<leader>q"] = false,
                        ["<leader>/"] = false,
                        ["<leader>ow"] = { "<cmd>w<cr>", desc = "Save" },
                        ["<leader>oq"] = { "<cmd>q!<cr>", desc = "Quit" },
                        ["<leader>oW"] = { "<cmd>wq<cr>", desc = "Save file & Quit" },
                        ["<leader>o/"] = {
                                function()
                        ...
                        ["<leader>h"] = false,
                        ["<leader>uh"] = { "<cmd>nohlsearch<cr>", desc = "No Highlight" }, -- TODO: REMOVE IN v3
                        ["<leader>d"] = false,
                        ["<leader>bd"] = {
